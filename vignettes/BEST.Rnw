...
We will use the hypothetical data from \citet{Kruschke2013BEST}: ``Consider data from two groups of people who take an IQ test. Group 1 ($N_1 = 47$) consumes a ``smart drug'' while Group 2 ($N_2 = 42$) is a control group that consumes a placebo.''
...
This is implemented as a three-step process. For a discussion of the advantages of this procedure, see \citet{Kruschke2013BEST}.
...
If you want to know the details of how the functions in the \code{BEST} package work, you can download the \R{} source code from GitHub \url{https://github.com/mikemeredith/BEST}

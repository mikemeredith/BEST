...
test_that("BESTpower retro with 2 groups gives same output",  {
  ...
  if(packageVersion("rjags") >= "4.0.0")  {
    expect_that(round(pow2[, 1], 5),
      is_equivalent_to(c(0.27273, 0.09091, 0.09091, 0.18182, 0.09091, 0.09091, 0.27273, 0.18182, 0.18182, 0.09091, 0.09091, 0.09091)))
    expect_that(round(pow2[, 2], 5),
      is_equivalent_to(c(0.04645, 0, 0, 0.00729, 0, 0, 0.04645, 0.00729,
        0.00729, 0, 0, 0)))
...
if(packageVersion("rjags") >= "4.0.0")  {
    expect_that(round(pow1[, 1], 5),
      is_equivalent_to(c(0.90909, 0.09091, 0.09091, 0.90909, 0.09091, 0.09091, 0.81818, 0.90909, 0.54545, 0.09091, 0.09091, 0.09091)))
    expect_that(round(pow1[, 2], 5),
      is_equivalent_to(c(0.74113, 0, 0, 0.74113, 0, 0, 0.60219, 0.74113, 0.26839, 0, 0, 0)))
    expect_that(round(pow1[, 3], 5),
      is_equivalent_to(c(1.00000, 0.25887, 0.25887, 1, 0.25887, 0.25887, 0.99271, 1, 0.81845, 0.25887, 0.25887, 0.25887)))
  }
})

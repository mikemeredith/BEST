...
test_that("BESTpower retro with 2 groups gives same output",  {
  ...
  if(packageVersion("rjags") >= "4.0.0")  {
    expect_that(round(pow2[, 1], 5),
      is_equivalent_to(c(0.36364, 0.09091, 0.09091, 0.27273, 0.09091, 0.09091, 0.45455, 0.36364, 0.09091, 0.09091, 0.09091, 0.09091)))
    expect_that(round(pow2[, 2], 5),
      is_equivalent_to(c(0.10678, 0, 0, 0.04645, 0, 0, 0.18155, 0.10678, 0, 0, 0, 0)))
    expect_that(round(pow2[, 3], 5),
      is_equivalent_to(c(0.63320, 0.25887, 0.25887, 0.52243, 0.25887, 0.25887, 0.73161, 0.63320, 0.25887, 0.25887, 0.25887, 0.25887)))
  }
})
...
test_that("BESTpower retro with 1 group gives same output",  {
  ...
  if(packageVersion("rjags") >= "4.0.0")  {
    expect_that(round(pow1[, 1], 5),
      is_equivalent_to(c(0.81818, 0.09091, 0.09091, 0.90909, 0.09091, 0.09091, 0.63636, 0.90909, 0.45455, 0.09091, 0.09091, 0.09091)))
    expect_that(round(pow1[, 2], 5),
      is_equivalent_to(c(0.60219, 0, 0, 0.74113, 0, 0, 0.36680, 0.74113, 0.18155, 0, 0, 0)))
    expect_that(round(pow1[, 3], 5),
      is_equivalent_to(c(0.99271, 0.25887, 0.25887, 1, 0.25887, 0.25887, 0.89322, 1, 0.73161, 0.25887, 0.25887, 0.25887)))
  }
})
